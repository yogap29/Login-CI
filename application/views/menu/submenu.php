                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="" class="badge badge-info" data-toggle="modal"
                                data-target="#editsubmenu<?= $sm['id'];?>">Edit</a>
                            <!-- DELETE -->
                            <a href="<?= base_url('menu/delsm/').$sm['id']; ?>"
                                onclick="return confirm ('Submenu will be deleted, continue?')"
...
<div class="modal fade" id="editsubmenu<?= $sm['id'];?>" tabindex="-1"
    aria-labelledby="editsubmenuLabel<?= $sm['id'];?>" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
